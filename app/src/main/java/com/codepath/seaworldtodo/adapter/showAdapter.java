...
public class showAdapter extends ArrayAdapter<ShowModel> {
    public showAdapter(Context context, ArrayList<ShowModel> users) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ShowModel show = getItem(position);
        // Check if an existing view is being reused, otherwise inflate the view
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.showmodel, parent, false);
        }
